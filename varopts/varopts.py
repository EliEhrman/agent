...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_varopts')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_varopts')
...
class intArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _varopts.intArray_frompointer
...
class charArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _varopts.charArray_frompointer
...
class strArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _varopts.strArray_frompointer
