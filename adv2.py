...
c_phrase_bitvec_dict_fnt = '~/tmp/adv_bin_dict.txt'
c_nlbitvec_dict_input_fnt = '~/tmp/glv_bin_dict.txt' # '~/tmp/glv_bin_dict_small.txt' #
...
c_bitvec_saved_phrases_fnt = '~/tmp/saved_phrases.txt' # '~/tmp/saved_phrases_small.txt' #
...
g_dummy_idx = -1
c_b_gpsai = False
c_lrn_rule_fn = 'learn' # 'load', 'learn', 'none'
